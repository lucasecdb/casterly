...
export const appServerEntry = resolveModule(resolveApp, 'src/app-server')
export const appBrowserEntry = resolveModule(resolveApp, 'src/app-browser')
export const appRoutesJs = resolveModule(resolveApp, 'src/routes')
export const appLoaderRuntime = resolveModule(resolveApp, 'src/loader')
